...
<div id="primary" class="content-area">
	...
	$promo_category_slider = get_theme_mod( 'promo_category_slider', false );
	if ( true == $featuredsection ) :
		get_template_part( 'template-parts/featured', 'layout' );
	endif;
	if ( true === $promo_category_slider ) :
					...
					<div class="<?php echo esc_attr( $blogcontent ); ?>">
						...
						if ( have_posts() ) :
							...
							if ( 'grid' == $get_blog_layout ) {
								...
								$pagination_alignment = get_theme_mod( 'blog_page_pagination', 'left' );
