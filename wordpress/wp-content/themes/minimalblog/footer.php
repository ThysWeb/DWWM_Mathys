...
<?php
// if ( minimalblog_not_page_template() === true ) :
...
// 	endif;
// 	$show_instagram_section = get_theme_mod( 'instagram_section_on_off', false );
// 	if ( $show_instagram_section === true ) :
// 		get_template_part( 'template-parts/instagram', 'media' );
// 	endif;
// 	echo 'this is not contact page.';
// else:
// 	echo 'this is contact page';
// endif;


if (true === minimalblog_not_page_template()) {
...
?>
	<footer id="colophon" class="site-footer">
		...
		if ( true == $get_footer_credit ) :
			$footer_credit = minimalblog_footer_credit();
		else:
			$footer_credit = '';
		endif;
				...
				<div class="col-md-6 text-left">
					<div class="site-info">
						...
						if ( ! empty( $getcopyrighttext ) ) {
							...
							esc_html_e( 'Copyright © 2020 All Rights Reserved.', 'minimalblog' );
							echo $footer_credit;
						}
						?>
					</div><!-- .site-info -->
